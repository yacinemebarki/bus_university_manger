...
public class bus_view {
    ...
    public bus_view() {
        ...
        // ================= INPUT SECTION =================
        matriculeLabel.setBounds(40, 60, 100, 25);
        matriculeField.setBounds(150, 60, 210, 25);

        workStatusCombo.setBounds(380, 60, 150, 25);
        problemStatusCombo.setBounds(550, 60, 150, 25);

        capacityLabel.setBounds(730, 60, 80, 25);
        capacityField.setBounds(810, 60, 80, 25);

        // ================= BUTTONS =================
        addBusBtn.setBounds(40, 110, 160, 35);
        removeBusBtn.setBounds(220, 110, 160, 35);
        searchBtn.setBounds(400, 110, 140, 35);
        statusBtn.setBounds(560, 110, 150, 35);
        searchTypeCombo.setBounds(730, 150, 220, 30);

        // ================= TABLE =================
        scroll.setBounds(40, 170, 980, 390);
